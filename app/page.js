...
export default function Home() {
  return (
    <div>
      ...
      {/* Hero */}
      <section className="bg-gradient-to-r from-accent1 to-accent2 text-white py-32 text-center relative overflow-hidden">
        ...
        <a
          href="#contacto"
          className="bg-white text-accent1 px-10 py-4 rounded-full font-semibold shadow-lg hover:bg-gray-100 hover:scale-105 inline-block transition-transform"
        >
          Conversemos
        </a>
      </section>
      ...
      <section id="expertise" className="py-24 container mx-auto px-6">
        ...
        <div className="grid md:grid-cols-3 gap-10">
          <div className="bg-white shadow-xl rounded-2xl p-8 hover:shadow-2xl hover:scale-105 transition-transform text-center">
            <FaRobot className="text-accent1 mx-auto mb-5 text-5xl" />
          ...
          <div className="bg-white shadow-xl rounded-2xl p-8 hover:shadow-2xl hover:scale-105 transition-transform text-center">
            <FaChartLine className="text-accent2 mx-auto mb-5 text-5xl" />
          ...
          <div className="bg-white shadow-xl rounded-2xl p-8 hover:shadow-2xl hover:scale-105 transition-transform text-center">
            <FaDatabase className="text-accent3 mx-auto mb-5 text-5xl" />
      ...
      <section id="impacto" className="py-24 container mx-auto px-6">
        ...
        <div className="grid md:grid-cols-3 gap-10">
          <div className="bg-accent1 text-white rounded-2xl p-10 shadow-lg text-center hover:scale-105 transition-transform">
            <h3 className="text-4xl font-bold mb-3">+20%</h3>
            <p>Aumento en ventas con modelos de predicción de demanda</p>
          </div>
          <div className="bg-accent2 text-white rounded-2xl p-10 shadow-lg text-center hover:scale-105 transition-transform">
            <h3 className="text-4xl font-bold mb-3">-15%</h3>
            <p>Reducción de costos logísticos aplicando optimización avanzada</p>
          </div>
          <div className="bg-accent3 text-white rounded-2xl p-10 shadow-lg text-center hover:scale-105 transition-transform">
      ...
      {/* Contacto */}
      <section id="contacto" className="bg-gradient-to-r from-accent1 to-accent2 text-white py-24 text-center">
        ...
        <a href="mailto:contacto@lens.mx" className="bg-white text-accent1 px-10 py-4 rounded-full font-semibold shadow-lg hover:bg-gray-100">
          Escríbenos
        </a>
      </section>
    </div>
